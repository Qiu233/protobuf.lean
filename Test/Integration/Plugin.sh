...
plugin_fixtures="$repo_root/Test/Fixtures/Plugin"
schema_fixtures="$repo_root/Test/Fixtures/Schemas"
...
"$protoc_bin" \
  ...
  --proto_path="$plugin_fixtures" \
  --proto_path="$schema_fixtures" \
...
"$protoc_bin" \
  ...
  < "$plugin_fixtures/forged-extension-request.textproto" \
...
"$protoc_bin" \
  ...
  --encode=google.protobuf.compiler.CodeGeneratorRequest \
  google/protobuf/compiler/plugin.proto \
  < "$plugin_fixtures/forged-identifier-request.textproto" \
...
run_forged_request() {
  ...
  "$protoc_bin" \
    ...
    --encode=google.protobuf.compiler.CodeGeneratorRequest \
    google/protobuf/compiler/plugin.proto \
    < "$plugin_fixtures/$stem-request.textproto" \
